...
import {
  ...
  Pencil, Check, Calendar, ShieldAlert, Info, History, Plus, UsersRound
} from "lucide-react";
...
const profissionaisOficiais = [
  ...
  const TABS = [
    ...
    { id: "profissionais", label: "Profissionais", icon: <UsersRound size={16} /> },
  ];
      ...
      <main className="max-w-[1088px] mx-auto px-4 md:px-6 py-6 flex flex-col gap-4">
        ...
        {activeTab === "profissionais" && (
          <EntityProfessionalsTab
            entityKey={`exploracao-pecuaria-${r.codigo}`}
            allowedTypes={[
