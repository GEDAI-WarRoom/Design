...
const PARAMETROS_GERAIS_RAW: ParametroGeralRaw[] = [
  ...
  ["prazoMaximoGtaGravada", "Prazo máximo, em dias, de permanência da GTA no status Gravada", "3"],
  ["prazoMaximoPagamentoGta", "Prazo máximo, em dias, para pagamento após a geração dos dados de cobrança", "2"],
  ["prazoMaximoEmissaoGtaPaga", "Prazo máximo, em dias, para emissão da GTA após a confirmação do pagamento", "3"],
