...
export function ReceitaForm({
  ...
  const update = (field: keyof typeof value, fieldValue: string) =>
    onChange?.({ ...value, [field]: fieldValue } as Pick<
      Receita,
      ...
      <Section title="Informações Básicas">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <FloatInput
            ...
            onChange={(next) => update("descricao", next)}
            maxLength={255}
            disabled={disabled}
          />
          <FloatSelect
