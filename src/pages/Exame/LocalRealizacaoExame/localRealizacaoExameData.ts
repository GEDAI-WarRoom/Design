...
export const VETERINARIOS_EXAME_MOCK: MedicoVeterinarioExame[] = [
  ...
  {
    id: 6,
    nome: "Dra. Fernanda Alves Ribeiro",
    cpf: "185.274.630-52",
    exames: ["Brucelose"],
    examesFormatados: "Brucelose",
    habilitado: true,
    localId: null,
  },
  {
    id: 7,
    nome: "Dr. Lucas Mendes Ferreira",
    cpf: "296.381.740-63",
    exames: ["Tuberculose"],
    examesFormatados: "Tuberculose",
    habilitado: true,
  ...
  {
    id: 8,
    nome: "Dra. Juliana Castro Lima",
    cpf: "307.492.851-74",
    exames: ["Brucelose", "Tuberculose"],
    examesFormatados: "Brucelose, Tuberculose",
    habilitado: true,
    localId: null,
  },
  {
    id: 9,
    nome: "Dr. Rafael Oliveira Campos",
    cpf: "418.503.962-85",
    exames: ["Mormo"],
    examesFormatados: "Mormo",
    habilitado: true,
    localId: null,
  },
  {
    id: 10,
    nome: "Dra. Beatriz Souza Moraes",
    cpf: "529.614.073-96",
    exames: ["Anemia Infecciosa Equina"],
    examesFormatados: "Anemia Infecciosa Equina",
    habilitado: true,
  ...
  {
    id: 11,
    nome: "Dr. Gustavo Almeida Barros",
    cpf: "630.725.184-07",
    exames: ["Brucelose", "Tuberculose"],
    examesFormatados: "Brucelose, Tuberculose",
    habilitado: true,
