...
import { ArrowLeft, ChevronLeft, ChevronRight, Eye, Pencil, ReceiptText, Search, Users } from "lucide-react";
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="border-b border-gray-100">
                    {["Contribuinte", "CPF/CNPJ", "Mês e ano para referência", "Valor", "Situação"].map((titulo) => (
                ...
                <tbody>
                  {linhas.map((registro) => (
                    <tr key={registro.id} className="border-b border-gray-50 hover:bg-gray-50/60">
                      <td className="px-3 py-3 text-gray-500">{registro.contribuinte.nome}</td>
                      <td className="whitespace-nowrap px-3 py-3 text-gray-500">{registro.contribuinte.documento}</td>
