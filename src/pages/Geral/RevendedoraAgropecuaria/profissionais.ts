...
export const PROFISSIONAIS_ANIMAL: ProfissionalAnimal[] = [
  ...
  { id: 1, nome: "Eloiza Silva", cpf: "444.009.956-40", formacao: "Médico Veterinário", numeroConselho: "512633", servicoOficial: "Sim", vacinacaoBrucelose: "Sim", habilitacoes: ["Emissão de GTA"], situacao: "Ativo" },
...
export const PROFISSIONAIS_VEGETAL: ProfissionalVegetal[] = [
  { id: 1, nome: "Eloiza Silva", documento: "444.009.956-40", formacao: "Engenheiro Agrônomo", crea: "506779200", habilitacao: "Habilitado para emissão de PTV", numeroHabilitacao: "31250001", situacao: "Ativo" },
